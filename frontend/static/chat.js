                ...
                <div class="sources-list">
                    ${sources.map((s, i) => `
                        <div class="source-item" title="${escapeHtml(s.content)}">
                            ...
                            <span class="source-title">${escapeHtml(s.title || s.source)}</span>
                        </div>
                    `).join('')}
                </div>
            `;
...
async function sendChatMessage() {
    ...
    try {
        const useRag = chatRagToggle.checked;
                ...
                ${sources.map((s, i) => `
                    <div class="source-panel-item" title="${escapeHtml(s.content || '')}">
                        ...
                        <div class="source-panel-content">
                            <div class="source-panel-title">${escapeHtml(s.title || s.source)}</div>
