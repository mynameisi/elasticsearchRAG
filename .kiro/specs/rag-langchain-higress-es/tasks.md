...
- [x] 2. Implement Elasticsearch index management
  - [x] 2.1 Create index mapping module
...
- [x] 3. Implement document processing pipeline
  - [x] 3.1 Create Markdown document loader module
  ...
  - [x] 3.3 Implement document indexing with deduplication
...
- [x] 5. Implement hybrid search functionality
  - [x] 5.1 Create custom query builder for RRF hybrid search
    - Implement RRF retriever combining semantic and full-text search
    - Exclude semantic_text from response source
    - _Requirements: 5.1, 5.2, 5.3_
  - [x] 5.2 Write property test for search result field exclusion
    - **Property 5: Search Results Exclude Semantic Field**
    - **Validates: Requirements 5.3**
  - [x] 5.3 Create search utility function
    - Wrap ElasticsearchStore.similarity_search with custom query
    - Return formatted results with metadata
    - _Requirements: 5.1, 5.2_

- [x] 6. Create main ingestion script
  - [x] 6.1 Implement load-markdown-into-es.py script
